...
ent-RCD = RCD
    .desc = The heavy-duty rapid construction device can be used to quickly place and remove various station structures and fixtures. Requires compressed matter to function.
ent-RPD = RPD
    .desc = A heavy-duty industrial device used to rapidly lay atmospheric infrastructure. Can be slung around the back of an engineering hardsuit.
ent-RCDEmpty = { ent-RCD }
    .suffix = Empty
    .desc = { ent-RCD.desc }
ent-RCDRecharging = experimental RCD
    .desc = A bluespace-enhanced rapid construction device that passively generates its own compressed matter, and is much more portable.
  .suffix = AutoRecharge
ent-RPDRecharging = experimental RPD
    .desc = A bluespace-enhanced rapid piping device that passively generates its own compressed matter, and is much more portable.
  .suffix = AutoRecharge
