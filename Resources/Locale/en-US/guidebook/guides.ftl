...
guide-entry-rtg = RTG
guide-entry-nuclearreactor = Nuclear Reactor
...
guide-entry-rules-sl-high-value = High-value property register
guide-entry-rules-sl-anti-corp = Anti-corporate equipment register
guide-entry-rules-sl-modifiers = Circumstances and sentencing
